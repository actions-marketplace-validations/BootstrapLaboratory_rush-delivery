...
in the [bounded local-copy guide](local-copy-source-imports.md).
...
compatibility path. Follow the [toolchain production guide](rush-toolchain.md)
and [mixed-language tutorial](tutorial/15-mixed-node-python-toolchain.md).
