...
This guide maps the Rush Delivery `v0.9.1` application-image provider contract
...
Delivery examples use `@v0.9.1` to identify this guide's release contract. In a
