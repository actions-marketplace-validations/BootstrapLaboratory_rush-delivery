...
- Complete [GitHub Actions](06-github-actions.md).
...
[Publish And Inspect](04-publish-and-inspect.md#failure-meaning).
...
repository's [`split-stage handoff test`](../../../test/split-stage-handoff.test.ts)
exercises
...
Next: return to the [OCI tutorial index](README.md) or use the
[OCI application-image reference](../../oci-application-images.md) while
