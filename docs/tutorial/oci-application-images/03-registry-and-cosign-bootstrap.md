# 3. Registry And Cosign Bootstrap
...
- Complete [Provider-Off Dry Run](02-provider-off-dry-run.md).
...
The checked-in
[`providers.yaml`](../../../examples/oci-application-image-rush-repo/.dagger/application-images/providers.yaml)
...
The canonical [`.gitignore`](../../../examples/oci-application-image-rush-repo/.gitignore)
...
Next: [Publish And Inspect](04-publish-and-inspect.md).
