...
- Complete [Publish And Inspect](04-publish-and-inspect.md).
...
The canonical
[`deploy/consume-image.sh`](../../../examples/oci-application-image-rush-repo/deploy/consume-image.sh)
...
Next: [GitHub Actions](06-github-actions.md).
