...
- Complete the [tutorial setup](README.md#create-a-clean-tutorial-repository).
...
[`apps/control-plane-api/scripts/build.mjs`](../../../examples/oci-application-image-rush-repo/apps/control-plane-api/scripts/build.mjs):
...
The complete
[`apps/control-plane-api/Dockerfile`](../../../examples/oci-application-image-rush-repo/apps/control-plane-api/Dockerfile)
...
[`grype.yaml`](../../../examples/oci-application-image-rush-repo/.dagger/application-images/grype.yaml):
...
Next: [Provider-Off Dry Run](02-provider-off-dry-run.md).
