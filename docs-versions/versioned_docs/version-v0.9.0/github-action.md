...
See [bounded local-copy imports](../local-copy-source-imports).
...
the [environment-profile tutorial](../tutorial/oci-application-images/environment-profiles),
...
publishes. Follow the [toolchain guide](../rush-toolchain) and
[mixed Node/Python tutorial](../tutorial/mixed-node-python-toolchain).
