...
The checked-in
[`providers.yaml`](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.9.0/examples/oci-application-image-rush-repo/.dagger/application-images/providers.yaml)
...
The canonical [`.gitignore`](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.9.0/examples/oci-application-image-rush-repo/.gitignore)
