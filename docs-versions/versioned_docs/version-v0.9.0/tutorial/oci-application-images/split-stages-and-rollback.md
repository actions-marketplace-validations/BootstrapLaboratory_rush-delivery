...
[Publish And Inspect](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.9.0/docs/tutorial/oci-application-images/04-publish-and-inspect.md#failure-meaning).
...
repository's [`split-stage handoff test`](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.9.0/test/split-stage-handoff.test.ts)
exercises
