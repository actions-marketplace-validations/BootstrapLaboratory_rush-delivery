---
title: "8 - Environment Profiles"
sidebar_label: "8 - Environment Profiles"
---
...
Complete the [provider-off](../provider-off-dry-run) and
[publication](../publish-and-inspect) chapters first.
...
[deployment compatibility examples](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.9.0/examples/deployment-environment-compatibility):
...
[publish and inspect](../publish-and-inspect). Every record must use the same
...
[application-image troubleshooting guide](../../../oci-application-image-troubleshooting)
and [registry recipes](../../../oci-registry-recipes).
