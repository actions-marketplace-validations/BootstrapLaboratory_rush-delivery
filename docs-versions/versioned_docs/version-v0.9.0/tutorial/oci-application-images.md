...
[canonical example](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.9.0/examples/oci-application-image-rush-repo) is the
...
8. [Environment-Selected Repository Profiles](environment-profiles)
