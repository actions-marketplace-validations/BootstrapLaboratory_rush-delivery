...
[`package-target`](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.8.0/schemas/package-target.schema.json),
[`application-image-providers`](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.8.0/schemas/application-image-providers.schema.json),
and [`package-manifest`](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.8.0/schemas/package-manifest.schema.json) schemas.
