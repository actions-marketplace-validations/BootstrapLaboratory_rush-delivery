...
[`v0.8.1` package-target schema](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.8.1/schemas/v0.8.1/package-target.schema.json).
...
The exact schema is
[`package-manifest.schema.json`](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.8.1/schemas/v0.8.1/package-manifest.schema.json).
